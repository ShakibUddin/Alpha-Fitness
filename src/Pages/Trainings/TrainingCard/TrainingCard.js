...
const TrainingCard = (props) => {
    ...
    return (
        <div style={{ minWidth: "300px" }} className="lg:w-2/5 md:w-3/5 sm:w-4/5 m-6 flex flex-col justify-between shadow-2xl rounded-lg overflow-hidden relative bg-white">
