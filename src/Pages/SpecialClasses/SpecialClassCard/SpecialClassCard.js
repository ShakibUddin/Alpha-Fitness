...
const SpecialClassCard = (props) => {
    ...
    return (
        <div style={{ minWidth: "300px" }} className={`m-6 flex justify-start shadow-2xl rounded-lg overflow-hidden w-8/12 bg-white ${index % 2 === 0 && "flex-row-reverse"}`}>
            <div className="w-2/4 h-full">
                <img className="w-full h-full object-cover" src={image} alt="" />
            </div>
            <div className="w-2/4 flex flex-col items-center justify-between">
