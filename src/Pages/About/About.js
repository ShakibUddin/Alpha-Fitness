        ...
        <div className="w-full mx-auto flex flex-col items-center ">
            ...
            <div className="w-full flex flex-wrap justify-evenly">
                <div className="lg:w-2/4 w-full flex flex-col items-center" style={{ minWidth: "250px" }}>
                    <p className="font-bold lg:text-5xl md:text-4xl text-3xl py-3 text-center text-black my-10">OUR STORY</p>
                    <p className="w-full p-4 mb-20 text-black">Alpha Fitness was founded in 2002 as a family owned and operated business. The Alpha Fitness founders didn’t want it to be just another gym equipment retailer - they wanted to be the best in the industry and set their minds to doing so! Since its birth, Alpha Fitness has grown into one of Australias largest fitness equipment retailers having helped over 50,000 customers live longer, happier and healthier lives</p>
                </div>
                <div className="lg:w-2/4 w-full flex flex-col items-center text-black" style={{ minWidth: "250px" }}>
                    <p className="font-bold lg:text-5xl md:text-4xl text-3xl py-3 text-center text-black my-10">What we do</p>
                    <p className="w-full p-4 mb-20 text-black">We want to help you live a fit and healthy lifestyle! We do this by helping you find the most suitable equipment for your home gym, studio or commercial gym, keeping your budget, lifestyle and fitness goals in mind. We stock a wide range of gym equipment, with strength equipment, cardio, cross training and so much more. Our awesome team is always keen to help, so please call us to discuss your needs.</p>
                </div>
            </div>
