...
const FeeCard = (props) => {
    ...
    return (
        <div style={{ minWidth: "300px" }} className="w-2/5 m-6 flex flex-col justify-between shadow-2xl bg-white">
            ...
            <div className="flex flex-col items-center">
                ...
                <button className="w-3/5 mx-auto my-3 font-bold text-2xl p-3  text-center bg-yellow-400 border- text-black uppercase">Join Now</button>
            </div>
        </div>
    );
};
