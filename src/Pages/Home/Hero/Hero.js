    ...
    return (
        <div className="w-full h-screen object-cover bg-fixed bg-blue-600 bg-blend-multiply relative" style={{ backgroundImage: `url(${mainbg})`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
            <div className="w-full h-5/6 flex flex-col justify-center items-center">
                ...
                <Link to={path}>
                    <button className="p-5 my-3 mx-auto bg-yellow-600 text-white uppercase font-bold transform -skew-x-12 border-4 border-yellow-600 lg:text-2xl text-xl" onClick={scrollTo}>Get Started
                    </button>
                </Link>
