...
let useJson = () => {
    ...
    return { trainings, setTrainings, successes, setSuccesses, membershipFees, setMembershipFees, HIITClasses, setHIITClasses, stories, setStories, specialClasses, setSpecialClasses };
}
